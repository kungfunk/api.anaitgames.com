...
{
    public static function comparePlainTextWithEncrypted($hash, $plain_text) {
        return self::phpbb_check_hash($plain_text, $hash);
    }

    public static function encrypText($text) {
        return self::phpbb_hash($text);
    }

    // TODO: get rid of all this phpbb old crypt methods
    private static function phpbb_check_hash($password, $hash)
    {
    ...
    private static function phpbb_hash($password)
    {
        $itoa64 = './0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
    ...
    private static function unique_id($extra = 'c')
    {
